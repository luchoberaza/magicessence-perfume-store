...
/**
 * Fondo animado de fibras (WebGL2). Portado de React Bits a TypeScript con un
 * uniform extra `uBackdrop` para que el color de fondo del shader coincida con
 * el `--background` del sitio en vez del gris azulado original.
 */
